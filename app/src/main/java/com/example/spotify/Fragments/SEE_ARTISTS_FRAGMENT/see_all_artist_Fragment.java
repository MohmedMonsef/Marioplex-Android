...
public class see_all_artist_Fragment extends Fragment implements LifecycleOwner {
    Search searchList;
    ...
    ImageView back_button_to_seeAllArtist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_see_all_artist_, container, false);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycleSearchSeeAllArtist);
        LinearLayoutManager layoutManager;
        layoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        Bundle args = getArguments();
        wordRecieve = getArguments().getString("DATA_RECIEVE_Artist");
        ArtistText.setText("' "+wordRecieve+"'"+"  in Artist ");
        //if(args!=null)
        // {
        //   ArtistText.setText(args.getString(DATA_RECIEVE)+" In Artist");
        // wordRecieve=args.getString(DATA_RECIEVE);
        //}
        back_button_to_seeAllArtist=view.findViewById(R.id.back_button_to_seeAllArtist);
        back_button_to_seeAllArtist.setOnClickListener(new View.OnClickListener()
        {
            @Override
    ...
    public void SetRetrofitsearchalbum(String s) {
        Call<Search> call = apiService.getSearch(s, "artist", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZTgwYzZhZjE0Yzg1NjZkNmNkOWI0MDAiLCJwcm9kdWN0IjoiZnJlZSIsInVzZXJUeXBlIjoiQXJ0aXN0IiwiaWF0IjoxNTg2MDI2NjAyLCJleHAiOjQ3MzI1MTMwMDJ9.ztEjNCgbkyJ2-9WB6ojwLgDfhWsZ-ZGJVFUB8dYMz8s");
